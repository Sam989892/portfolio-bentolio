...
function AboutHeader() {
  ...
  return (
    <motion.section
      ref={ref}
      className="bg-gradient-to-br from-[#e3f2f9] to-[#aecfdc]/30 rounded-[30px] p-8 mx-4 mt-20 mb-8 relative overflow-hidden"
...
function StatsSection() {
  ...
  const stats = [
    ...
    { number: portfolioConfig.experience.length.toString(), label: "Years Experience", desc: "Professional background" },
    { number: portfolioConfig.skills.technical.length.toString(), label: "Core Skills", desc: "Technical expertise areas" },
  ...
  return (
    <motion.section
      ref={ref}
      className="bg-gradient-to-br from-[#aecfdc] to-[#aecfdc]/80 rounded-[30px] p-8 mx-4 mb-8 relative overflow-hidden"
      initial={{ opacity: 0, y: 50 }}
      animate={inView ? { opacity: 1, y: 0 } : { opacity: 1, y: 0 }}
      transition={{ duration: 0.8 }}
    >
...
function SkillsSection() {
  ...
  const skills = [
    { category: "Technical Skills", items: portfolioConfig.skills.technical },
    { category: "Tools", items: portfolioConfig.skills.tools },
    { category: "Languages", items: portfolioConfig.skills.languages }
  ];
