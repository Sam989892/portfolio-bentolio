      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-[#aecfdc]/10 border border-[#aecfdc]/20 rounded-[15px] font-['Gilroy:Light',_sans-serif] text-[#000000] text-[16px] focus:outline-none focus:ring-2 focus:ring-[#aecfdc]/50 focus:border-transparent transition-all"
        ...
        >
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full px-4 py-3 bg-[#aecfdc]/10 border border-[#aecfdc]/20 rounded-[15px] font-['Gilroy:Light',_sans-serif] text-[#000000] text-[16px] focus:outline-none focus:ring-2 focus:ring-[#aecfdc]/50 focus:border-transparent transition-all resize-none"
