...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white/25 backdrop-blur-[10px] border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] rounded-[30px] p-8 mb-6 relative overflow-hidden"
    >
...
function ProjectsHeader() {
  ...
  return (
    ...
    >
      <motion.h1
        className="font-medium text-white text-[40px] sm:text-[48px] mb-4"
        initial={{ opacity: 0, y: 30 }}
        animate={inView ? { opacity: 1, y: 0 } : { opacity: 1, y: 0 }}
